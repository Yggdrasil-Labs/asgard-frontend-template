...
## [1.3.0](https://github.com/Yggdrasil-Labs/asgard-frontend-template/compare/v1.2.0...v1.3.0) (2026-09-21)
...
* **api:** 评审修正——分页契约类型化与环境变量加固 ([586b95d](https://github.com/Yggdrasil-Labs/asgard-frontend-template/commit/586b95d91facbc0da3380cda17b63794288a6e03))
* **api:** 错误判序修正——超时不再误报网络错误、取消原样透传 ([a609a1d](https://github.com/Yggdrasil-Labs/asgard-frontend-template/commit/a609a1d27bf1029ba2454a40c4efae663b49226b))
...
* **config:** 生产配置 fail-closed 并统一 /api 前缀约定 ([344e17d](https://github.com/Yggdrasil-Labs/asgard-frontend-template/commit/344e17de24246c0aacd79365f2361fe6b56c74c6))
* **deps:** upgrade fast-uri to patched 3.1.6 ([#135](https://github.com/Yggdrasil-Labs/asgard-frontend-template/issues/135)) ([67d0b35](https://github.com/Yggdrasil-Labs/asgard-frontend-template/commit/67d0b35835cfdb67eff626cbd2d3c9ff1da8f872))
...
* **layout:** 跨断点才重置壳层形态并统一 768 断点口径 ([0a9b238](https://github.com/Yggdrasil-Labs/asgard-frontend-template/commit/0a9b2386c657bd6d2ad3018827f57096b97d9372))
...
* **router:** keep-alive 缓存名对齐路由名并移除文件式路由双源 ([37f4dee](https://github.com/Yggdrasil-Labs/asgard-frontend-template/commit/37f4dee27fc8aa52be860869e480a2adddf973bf))
* **router:** 评审修正——keep-alive include 按文件名映射并清理死 API ([f1ffafd](https://github.com/Yggdrasil-Labs/asgard-frontend-template/commit/f1ffafd9cb7092bec270e05dbd913e77332b8a25))
...
* **type:** 重建类型检查门禁并修复 17 个真实类型错误 ([4d976f3](https://github.com/Yggdrasil-Labs/asgard-frontend-template/commit/4d976f3d25e021c3c54e78d052ae9055c0c3fb90))
...
* 同步 README 环境变量文档与生产必填说明 ([fc7309c](https://github.com/Yggdrasil-Labs/asgard-frontend-template/commit/fc7309cf66eb4dfce7f0c1c07904c7f939337bcd))
...
* **api:** HTTP 返回契约真实化并统一 ApiError 错误类型 ([29d0193](https://github.com/Yggdrasil-Labs/asgard-frontend-template/commit/29d0193cf5c38978989579be4a4da4f311c93b60))
...
* **deps:** bump the minor-and-patch group across 1 directory with 14 updates ([#134](https://github.com/Yggdrasil-Labs/asgard-frontend-template/issues/134)) ([cad900a](https://github.com/Yggdrasil-Labs/asgard-frontend-template/commit/cad900abd42f24b6c5b11d4cf809eaa358a2e505))
...
* **deps:** 升级前端依赖版本 ([7752be3](https://github.com/Yggdrasil-Labs/asgard-frontend-template/commit/7752be3e9eb1d26353bb295ee89084d4eb08e7d0))
