...
describe('responsive shell', () => {
  ...
  it('locks the shell to the viewport and delegates scrolling to the main region', async () => {
    ...
    expect(shellRoot?.dataset.scrollBoundary).toBe('viewport')
    expect(shellRoot?.dataset.density).toBe('compact')
    expect(shellViewport?.dataset.scrollBoundary).toBe('viewport')
    expect(shellViewport?.dataset.density).toBe('compact')
    expect(shellBody?.dataset.scrollBoundary).toBe('viewport')
    expect(shellBody?.dataset.density).toBe('compact')
    expect(header?.dataset.density).toBe('compact')
    expect(navToggle).toBeNull()
    expect(content?.dataset.scrollBoundary).toBe('viewport')
    expect(content?.dataset.density).toBe('compact')
    expect(main?.dataset.scrollBoundary).toBe('main')
    expect(main?.dataset.density).toBe('compact')
    expect(surface?.dataset.density).toBe('compact')
